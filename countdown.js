(() => {
  ...
  // September 6, 2026 at 12:00:00 am in Melbourne.
  // Melbourne is AEST (UTC+10) on this date, so fixing the instant in UTC
  // keeps the deadline identical even when the page is opened elsewhere.
  const unlockAt = Date.parse('2026-09-05T14:00:00.000Z');
  const SECOND = 1000;
